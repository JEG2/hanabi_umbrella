...
var _user$project$Game$renderFour = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$Game$renderThree = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$Game$renderTwo = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$Game$renderOne = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$Game$renderFirework = F3(
	function (xpos, ypos, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = A2(_elm_lang$core$Maybe$withDefault, 0, _p1._1);
		switch (_p2) {
			case 1:
				return A3(_user$project$Game$renderOne, xpos, ypos, _p3);
			case 2:
				return A3(_user$project$Game$renderTwo, xpos, ypos, _p3);
			case 3:
				return A3(_user$project$Game$renderThree, xpos, ypos, _p3);
			case 4:
				return A3(_user$project$Game$renderFour, xpos, ypos, _p3);
			case 5:
...
var _user$project$Game$tileAttributes = function (_p10) {
	var _p11 = _p10;
	var n = _elm_lang$core$Basics$toString(
		A2(_elm_lang$core$Maybe$withDefault, 0, _p11._1));
	var c = A2(_elm_lang$core$Maybe$withDefault, '', _p11._0);
	return {
		ctor: '::',
		_0: c,
		_1: {
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Discards:'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$svg,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								A2(_user$project$Game$handHeight, _p14, _p15)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width(
									A2(_user$project$Game$handWidth, _p16, _p15)),
								_1: {
									ctor: '::',
						...
						A2(
							...
							_user$project$Game$drawTile(
								{ctor: '_Tuple3', _0: _p16, _1: _p14, _2: _p15}),
							hand)),
					_1: {ctor: '[]'}
				}
			});
...
var _user$project$Game$drawFireworkTile = F3(
	function (_p18, idx, _p17) {
		...
		var ypos = A3(_user$project$Game$tileXpos, _p23, _p24, idx);
		var xpos = _p24;
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
	...
	function (fireworks, _p25) {
		...
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(((_p27 + _p28) * 5) + _p28)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString((_p28 + _p29) + _p28)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A3(
					...
					{ctor: '_Tuple3', _0: _p29, _1: _p27, _2: _p28},
					0,
					{
						ctor: '_Tuple2',
...
var _user$project$Game$shouldShowButtons = F2(
	function (myTurn, clocks) {
		return myTurn && (_elm_lang$core$Native_Utils.cmp(clocks, 0) > 0);
	});
var _user$project$Game$gameDetails = function (_p30) {
	var _p31 = _p30;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('game-details-container'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('draw'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Remaining Tiles: ',
							_elm_lang$core$Basics$toString(_p31.draw_pile))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fuses'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Fuses: ',
								_elm_lang$core$Basics$toString(_p31.fuses))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('timers'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Clocks: ',
									_elm_lang$core$Basics$toString(_p31.clocks))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'My Turn: ',
										_elm_lang$core$Basics$toString(_p31.my_data.turn))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				var payload = _elm_lang$core$Json_Encode$object(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'idx',
								_1: _elm_lang$core$Json_Encode$int(_p34._0)
							},
							_1: {ctor: '[]'}
						}
					});
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'hint',
									_1: _elm_lang$core$Json_Encode$string(_p34._1)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Game$renderButton = F2(
	function (name, hint) {
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$svg$Svg_Events$onClick(
					A2(_user$project$Game$Hint, name, hint)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Game$hintButtons = F2(
	function (name, hand) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Game$renderButton(name),
...
var _user$project$Game$renderTeamHand = F4(
	function (_p40, hintCtrls, name, hand) {
		var _p41 = _p40;
		var _p45 = _p41._0;
		var _p44 = _p41._2;
		var _p43 = _p41._1;
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$svg,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								A2(_user$project$Game$handHeight, _p43, _p44)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width(
									A2(_user$project$Game$handWidth, _p45, _p44)),
								_1: {
									ctor: '::',
						...
						A2(
							_elm_lang$core$List$indexedMap,
							_user$project$Game$drawTile(
								{ctor: '_Tuple3', _0: _p45, _1: _p43, _2: _p44}),
							hand)),
					_1: {
						ctor: '::',
						_0: A2(
...
var _user$project$Game$renderTeamHands = F3(
	function (hands, dimensions, hintCtrls) {
		return _elm_lang$core$Dict$values(
			A2(
				_elm_lang$core$Dict$map,
				A2(_user$project$Game$renderTeamHand, dimensions, hintCtrls),
				hands));
	});
...
var _user$project$Game$drawPlayerTile = F4(
	function (_p47, my_turn, idx, _p46) {
		var _p48 = _p47;
		var _p55 = _p48._0;
		var _p54 = _p48._2;
		var _p53 = _p48._1;
		...
		var _p51 = _p49._0;
		var ypos = _p54;
		var xpos = A3(_user$project$Game$tileXpos, _p55, _p54, idx);
		var _p50 = my_turn;
		if (_p50 === true) {
			return A2(
				_elm_lang$svg$Svg$g,
...
var _user$project$Game$renderPlayerHand = F4(
	function (hand, _p56, name, my_turn) {
		var _p57 = _p56;
		var _p60 = _p57._0;
		var _p59 = _p57._2;
		var _p58 = _p57._1;
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$svg,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								A2(_user$project$Game$handHeight, _p58, _p59)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$width(
									A2(_user$project$Game$handWidth, _p60, _p59)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$class(
										A2(_elm_lang$core$Basics_ops['++'], name, '-hand')),
						...
						A2(
							...
							A2(
								...
								{ctor: '_Tuple3', _0: _p60, _1: _p58, _2: _p59},
								my_turn),
							hand)),
					_1: {ctor: '[]'}
				}
...
var _user$project$Game$playSurface = function (_p61) {
	var _p62 = _p61;
	var _p63 = _p62.my_data;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('game-surface-container'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('hands-container'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
						...
						_1: {
							...
							_0: A2(
								...
								A3(
									...
									_p62.hands,
									{ctor: '_Tuple3', _0: 100, _1: 60, _2: 10},
									A2(_user$project$Game$shouldShowButtons, _p63.turn, _p62.clocks))),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Game$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Game$playSurface(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _user$project$Registration$selectOptions = function (playerCount) {
	return A2(
		_elm_lang$core$List$map,
		function (i) {
			return A2(
				_elm_lang$html$Html$option,
				{
					...
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(i, playerCount)),
					_1: {
						ctor: '::',
...
var _user$project$Registration$Response = F3(
	function (a, b, c) {
		return {success: a, userName: b, message: c};
	});
var _user$project$Registration$responseDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Registration$Response,
...
var _user$project$Registration$Complete = function (a) {
	return {ctor: 'Complete', _0: a};
};
var _user$project$Registration$InLobby = F2(
	function (a, b) {
		return {ctor: 'InLobby', _0: a, _1: b};
	});
var _user$project$Registration$Unregistered = function (a) {
	return {ctor: 'Unregistered', _0: a};
};
var _user$project$Registration$init = _user$project$Registration$Unregistered('');
var _user$project$Registration$HandleRegisterResponse = function (a) {
	return {ctor: 'HandleRegisterResponse', _0: a};
};
var _user$project$Registration$Register = function (a) {
	return {ctor: 'Register', _0: a};
};
var _user$project$Registration$EnterUserName = function (a) {
	return {ctor: 'EnterUserName', _0: a};
};
var _user$project$Registration$viewUnregistered = function (userName) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(
				_user$project$Registration$Register(userName)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('user_name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('user_name'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$name('user_name'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(userName),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Registration$EnterUserName),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Registration$HandleJoinGameResponse = function (a) {
	return {ctor: 'HandleJoinGameResponse', _0: a};
};
var _user$project$Registration$JoinGame = F2(
	function (a, b) {
		return {ctor: 'JoinGame', _0: a, _1: b};
	});
var _user$project$Registration$ChoosePlayerCount = function (a) {
	return {ctor: 'ChoosePlayerCount', _0: a};
};
var _user$project$Registration$viewRegistered = F3(
	function (userName, playerCount, model) {
		return A2(
			_elm_lang$html$Html$form,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(
					A2(_user$project$Registration$JoinGame, userName, playerCount)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Hi ', userName)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Join a '),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Registration$ChoosePlayerCount),
										_1: {ctor: '[]'}
									},
									_user$project$Registration$selectOptions(playerCount)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' player game.'),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Registration$InLobbyMsg = function (a) {
	return {ctor: 'InLobbyMsg', _0: a};
};
var _user$project$Registration$updateInLobby = F5(
	function (msg, userName, playerCount, socket, msgMapper) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChoosePlayerCount':
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: A2(_user$project$Registration$InLobby, userName, _p0._0),
						_1: socket
					},
			...
			case 'JoinGame':
						...
						function (resp) {
							return msgMapper(
								_user$project$Registration$InLobbyMsg(
									_user$project$Registration$HandleJoinGameResponse(resp)));
						},
						A2(
							_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
							payload,
				...
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: A2(_user$project$Registration$InLobby, userName, playerCount),
						_1: newSocket
					},
					_1: joinCmd
				};
			default:
				var result = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Registration$responseDecoder, _p0._0);
				var _p2 = result;
				if (_p2.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: {
							ctor: '_Tuple2',
							_0: _user$project$Registration$Complete(_p2._0.userName),
							_1: socket
						},
						_1: _elm_lang$core$Platform_Cmd$none
					};
...
var _user$project$Registration$UnregisteredMsg = function (a) {
	return {ctor: 'UnregisteredMsg', _0: a};
};
var _user$project$Registration$updateUnregistered = F4(
	function (msg, userName, socket, msgMapper) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'EnterUserName':
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: _user$project$Registration$Unregistered(_p3._0),
						_1: socket
					},
					_1: _elm_lang$core$Platform_Cmd$none
				};
						...
						function (resp) {
							return msgMapper(
								_user$project$Registration$UnregisteredMsg(
									_user$project$Registration$HandleRegisterResponse(resp)));
						},
						A2(
							_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
							payload,
							A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'register', 'game:lobby'))));
				var newSocket = _p4._0;
				var registerCmd = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: {
						ctor: '_Tuple2',
						_0: _user$project$Registration$Unregistered(_p5),
						_1: newSocket
					},
					_1: registerCmd
				};
		...
		switch (_p0.ctor) {
			...
			case 'RegistrationMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{registration: registration, phxSocket: phxSocket}),
		...
		if (_p6.ctor === 'Just') {
			...
			return A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Waiting for more players.  ', 'Have a nice glass of water and enjoy the weather.')),
					_1: {ctor: '[]'}
				});
		}
	});
...
if (typeof _user$project$HanabiUi$main !== 'undefined') {
    _user$project$HanabiUi$main(Elm['HanabiUi'], 'HanabiUi', undefined);
}
