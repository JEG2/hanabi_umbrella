...
var _user$project$HanabiUi$renderFive = F3(
...
var _user$project$HanabiUi$renderFour = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$HanabiUi$renderThree = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$HanabiUi$renderTwo = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$HanabiUi$renderOne = F3(
	function (xpos, ypos, color) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$HanabiUi$renderFirework = F3(
	function (xpos, ypos, _p0) {
		...
		switch (_p2) {
			case 1:
				return A3(_user$project$HanabiUi$renderOne, xpos, ypos, _p3);
			case 2:
				return A3(_user$project$HanabiUi$renderTwo, xpos, ypos, _p3);
			case 3:
				return A3(_user$project$HanabiUi$renderThree, xpos, ypos, _p3);
			case 4:
				return A3(_user$project$HanabiUi$renderFour, xpos, ypos, _p3);
			case 5:
				return A3(_user$project$HanabiUi$renderFive, xpos, ypos, _p3);
			default:
				return A2(
					_elm_lang$svg$Svg$g,
					{ctor: '[]'},
...
var _user$project$HanabiUi$tileXpos = F3(
	function (w, padding, idx) {
		return (padding + (idx * w)) + (idx * padding);
	});
var _user$project$HanabiUi$drawTile = F3(
	function (_p5, idx, _p4) {
		...
		var _p7 = _p4;
		var ypos = _p8;
		var xpos = A3(_user$project$HanabiUi$tileXpos, _p9, _p8, idx);
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$HanabiUi$renderFirework,
						xpos,
						ypos,
	...
	function (hand, _p10, name) {
		...
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					A2(_user$project$HanabiUi$handHeight, _p12, _p13)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						A2(_user$project$HanabiUi$handWidth, _p14, _p13)),
					_1: {
						ctor: '::',
			...
			A2(
				...
				_user$project$HanabiUi$drawTile(
					{ctor: '_Tuple3', _0: _p14, _1: _p12, _2: _p13}),
				hand));
	});
var _user$project$HanabiUi$teamHand = F3(
	function (dimensions, name, hand) {
		return A3(_user$project$HanabiUi$renderPlayerHand, hand, dimensions, name);
	});
var _user$project$HanabiUi$renderTeamHands = F2(
	function (hands, dimensions) {
		return _elm_lang$core$Dict$values(
			A2(
				_elm_lang$core$Dict$map,
				_user$project$HanabiUi$teamHand(dimensions),
				hands));
	});
var _user$project$HanabiUi$renderDiscardPile = F2(
...
var _user$project$HanabiUi$drawFireworkTile = F3(
	function (_p16, idx, _p15) {
		...
		var ypos = A3(_user$project$HanabiUi$tileXpos, _p21, _p22, idx);
		var xpos = _p22;
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
...
var _user$project$HanabiUi$renderFireworkPile = F2(
	function (fireworks, _p23) {
		...
		return A2(
			...
			},
			{
				ctor: '::',
				_0: A3(
					_user$project$HanabiUi$drawFireworkTile,
					...
					_1: {
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: A2(
									_user$project$HanabiUi$renderFireworkPile,
									model.fireworks,
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: A3(
										_user$project$HanabiUi$renderPlayerHand,
										model.my_hand,
										{ctor: '_Tuple3', _0: 100, _1: 60, _2: 10},
										'player'),
									_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_user$project$HanabiUi$renderTeamHands,
										model.hands,
										{ctor: '_Tuple3', _0: 100, _1: 60, _2: 10})),
								_1: {
									ctor: '::',
									_0: A2(
										...
										},
										{
											ctor: '::',
											_0: A2(
												_user$project$HanabiUi$renderDiscardPile,
												model.discards,
												{ctor: '_Tuple3', _0: 100, _1: 60, _2: 10}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$HanabiUi$tileDecoder = A3(
...
var _user$project$HanabiUi$fireworkDecoder = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$HanabiUi$Fireworks,
	A2(
...
var _user$project$HanabiUi$NoOp = {ctor: 'NoOp'};
