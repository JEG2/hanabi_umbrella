	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'RegistrationMsg':
				...
				var registration = _p1._0._0;
				var phxSocket = _p1._0._1;
				var registrationCmd = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
	...
	switch (_p4.ctor) {
		...
		case 'InLobby':
			return A2(
				...
				_user$project$Registration$view(model.registration));
		default:
			return A2(_user$project$HanabiUi$viewPlaying, _p4._0, model);
	}
};
...
var _user$project$HanabiUi$initSocket = A2(
	...
	A4(
		...
		'game',
		'game:lobby',
		_user$project$HanabiUi$AssignGame,
...
var _user$project$HanabiUi$init = function () {
	var _p5 = _user$project$HanabiUi$initSocket;
